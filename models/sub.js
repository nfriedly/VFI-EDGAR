  ...
  Sub.init(
    {
      adsh: {
        ...
        primaryKey: true,
        comment:
          "Accession Number. The 20-character string formed from the 18-digit number assigned by the SEC to each EDGAR submission. (nnnnnnnnnn-nn-nnnnnn)"
      },
      cik: {
      ...
      sic: {
        ...
        allowNull: true,
        comment:
          "Standard Industrial Classification (SIC). Four digit code assigned by the SEC as of the filing date, indicating the registrant’s type of business."
      },
      countryba: {
      ...
      stprinc: {
        ...
        allowNull: true,
        comment:
          "The state or province of incorporation for the registrant, if countryinc is US or CA."
      },
      ein: {
        type: Sequelize.INTEGER,
        allowNull: true,
      ...
      wksi: {
        ...
        allowNull: false,
        comment:
          "Well Known Seasoned Issuer (WKSI). An issuer that meets specific SEC requirements at some point during a 60-day period preceding the date the issuer satisfies its obligation to update its shelf registration statement."
      },
      fye: {
      ...
      filed: {
        ...
        allowNull: false,
        comment:
          "The date of the registrant’s filing with the Commission. (yymmdd)"
      },
      accepted: {
        type: Sequelize.DATE,
        allowNull: false,
        comment:
          "The acceptance date and time of the registrant’s filing with the Commission. Filings accepted after 5:30pm EST are considered filed on the following business day. (yyyy‑mm‑dd hh:mm:ss)"
      },
      prevrpt: {
        type: Sequelize.BOOLEAN,
        allowNull: false,
        comment:
          "Previous Report –TRUE indicates that the submission information was subsequently amended."
      },
      detail: {
        type: Sequelize.BOOLEAN,
        allowNull: false,
